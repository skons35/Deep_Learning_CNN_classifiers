...
1. Clone this repositiory , create the data folder, and then download and unzip the needed dataset of skin images as described below.  
```text
git clone https://github.com/skons35/Deep_Learning_CNN_classifiers.git
mkdir data
cd data
```
2. folders to hold the training, validation, and test images.
```text
